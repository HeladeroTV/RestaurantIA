...
@inventario_app.get("/inventario", response_model=List[InventarioResponse])
...
@inventario_app.post("/inventario", response_model=InventarioResponse)
...
@inventario_app.put("/inventario/{item_id}", response_model=InventarioResponse)
...
@inventario_app.delete("/inventario/{item_id}")
